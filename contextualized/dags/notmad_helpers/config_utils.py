...
def get_args():
    ...
    ##### General settings #####
    parser.add_argument(
        "--use_gpu", type=bool, default=False, help="Whether or not to use GPU"
    )

    parser.add_argument("--seed", type=int, default=1230, help="Reproducibility")

    ##### Dataset settings #####
    parser.add_argument(
        "--n", type=int, default=1000, help="Number of observation data"
    )
    ...
    parser.add_argument("--degree", type=int, default=4, help="Degree of graph")
    ...
    parser.add_argument(
        "--noise_scale", type=float, default=1.0, help="Variance for Gaussian Noise"
    )
    ...
    parser.add_argument(
        "--iter_step", type=int, default=1500, help="Number of steps for each iteration"
    )
    ...
    parser.add_argument(
        "--h_tol", type=float, default=1e-8, help="Tolerance of optimization problem"
    )

    parser.add_argument(
        "--init_rho", type=float, default=1.0, help="Initial value for rho"
    )

    parser.add_argument(
        "--rho_thres", type=float, default=1e12, help="Threshold for rho"
    )

    parser.add_argument("--h_thres", type=float, default=0.25, help="Threshold for h")
