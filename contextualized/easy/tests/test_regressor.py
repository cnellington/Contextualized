...
class TestEasyRegression(unittest.TestCase):
    ...
    def test_regressor(self):
        ...
        self._quicktest(model, C, X, Y, max_epochs=10, learning_rate=1e-3, es_patience=float('inf'))
        ...
        self._quicktest(
            model, C, X, Y, max_epochs=10, n_bootstraps=2, learning_rate=1e-3, es_patience=float('inf')
        )
