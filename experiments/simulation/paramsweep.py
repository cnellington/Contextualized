...
num_archetypes_list = [0, 100]
encoder_width_list = [50, ]
encoder_layers_list = [3, ]
final_dense_size_list = [10, ]
l1_list = [0.001, ]
bootstraps = None
invariant_params = {
    'context_dim': c,
...
if not os.path.exists(script_path):
    header = ['k'] + target_params + ['mse', 'mse_var', 'norm', 'norm_var', 'edge_var']
...
for _ in range(runs):
    ...
    for k in k_vals:
        ...
        for paramset in paramsets:
            ...
            vals = [k] + list(paramset) + [mse, mse_var, norm, norm_var, edge_var]
